...
import { fetchQuestionByComplexity } from '@/utils/questionApi';
...
export default function CodeRoom({ id, difficulty }: PageProps) {
  ...
  async function fetchQuestion() {
    const result = await fetchQuestionByComplexity(difficulty);
    socket.emit(MATCH_QUESTION_EVENT, { question: result, room: id})
    return result;
  }
