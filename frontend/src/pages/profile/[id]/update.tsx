...
export default function ProfileUpdate() {
  ...
  async function handleSubmit() {
    if (
      userProfileData.password.length > 0 &&
      !validatePassword(userProfileData.password)
    ) {
      toast({
        position: "top",
            ...
            <Container maxW="2xl">
              <Stack>
                ...
                <FormControl>
                  ...
                  <Input
                    placeholder="What is your highest educational qualification?"
                ...
                <FormControl>
                  <FormLabel>Professional work</FormLabel>
                  <Input
                    placeholder="What is your professional job?"
                    value={userProfileData.work}
